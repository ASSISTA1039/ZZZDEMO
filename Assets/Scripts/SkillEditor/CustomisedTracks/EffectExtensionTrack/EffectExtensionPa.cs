...
namespace Assista.SkillEditor
{
    ...
    public class EffectExtensionPa : PlayableAsset, IPropertyPreview, ITimelineClipAsset
    {
        ...
        [SerializeField] public ExposedReference<GameObject> sourceGameObject
        {
            get
            {
                if (!_sourceGameObject.defaultValue)
                    _sourceGameObject.defaultValue = GameObject.FindWithTag("VFXParentGameObject");
        ...
        [SerializeField] public ExposedReference<Transform> EffectTransform;
        ...
        EffectExtensionPb effectExtensionPb = new EffectExtensionPb();
        ...
        public override Playable CreatePlayable(PlayableGraph graph, GameObject go)
        {
            ...
            var scriptPlayable = ScriptPlayable<EffectExtensionPb>.Create(graph, effectExtensionPb);
            EffectExtensionPb playable = scriptPlayable.GetBehaviour();
            playable.EffectTransform = EffectTransform.Resolve(graph.GetResolver());
            playable.prefabGameObject = prefabGameObject;
            playable.sourceObject = sourceObject;
            playable.graph = graph;
            playable.EffectExtensionPa = this;
            playable.playables = playables;
            playable.updateParticle = updateParticle;
            playable.updateDirector = updateDirector;
            playable.searchHierarchy = searchHierarchy;
            playable.s_SubEmitterCollector = s_SubEmitterCollector;
            playable.k_EmptyParticlesList = k_EmptyParticlesList;
            playable.k_EmptyDirectorsList = k_EmptyDirectorsList;
            playable.m_SupportLoop = m_SupportLoop;
            //playable.m_Duration = m_Duration;
            playable.controllingParticles = controllingParticles;
            playable.particleRandomSeed = particleRandomSeed;
            playable.s_CreatedPrefabs = s_CreatedPrefabs;
